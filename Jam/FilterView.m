...
-(void)createView
{
    listArray=[[NSArray alloc] initWithObjects:@"Homo",@"Mensajes", @"Notificaciones", @"Búsqueda", @"Salir", nil];
    self.backgroundColor = [UIColor whiteColor];
    
    tableViewOfSlider=[[UITableView alloc] init];
    [tableViewOfSlider setFrame:CGRectMake(0, 20, screenBounds.size.width - 1, screenBounds.size.height - 80)];
    [tableViewOfSlider setBounces:NO];
    [tableViewOfSlider setBackgroundColor:[UIColor redColor]];
    ...
    [filtersButton setTitle:@"DONE" forState:UIControlStateNormal];
    filtersButton.frame = CGRectMake(60, screenBounds.size.height - 40, 200, 15);
