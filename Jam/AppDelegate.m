...
- (void)application:(UIApplication*)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData*)deviceToken
{
    ...
    //    UIAlertView *tokenAlert=[[UIAlertView alloc]initWithTitle:@"Token" message:[NSString stringWithFormat:@"%@",newToken] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
    //    [tokenAlert show];
